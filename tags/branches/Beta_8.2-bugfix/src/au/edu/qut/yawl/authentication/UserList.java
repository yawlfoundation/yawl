...
import au.edu.qut.yawl.admintool.TableCreatorPostgres;
...
public class UserList {
    ...
    public synchronized void removeUser(String inSessionUserID, String userNameToDelete) throws YAuthenticationException {
        ...
        try
        {
            removeUser(null, inSessionUserID, userNameToDelete);
        }
        catch (YPersistenceException e)
        {
            // This should not happen as this is the non-persistence/engine interface
        }
    }
