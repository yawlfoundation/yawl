...
<%!
    org.yawlfoundation.yawl.worklist.model.WorklistController _worklistController = null;
    String _ixURI ;

    public void jspInit(){
                   ServletContext context = getServletContext();
        _worklistController = (WorklistController) context.getAttribute(
                "org.yawlfoundation.yawl.worklist.model.WorklistController");
        if(_worklistController == null){
            ...
            context.setAttribute("org.yawlfoundation.yawl.worklist.model.WorklistController",
                    _worklistController);
        }
