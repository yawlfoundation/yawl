...
<form method="post" action="http://localhost:8080/admintool/spec" name="deleteService">
<table>	
	<tr>
	<td>
...
<tr>
        <td align="left">
        <form action="http://localhost:8080/admintool/spec" enctype="MULTIPART/FORM-DATA" method=post>
