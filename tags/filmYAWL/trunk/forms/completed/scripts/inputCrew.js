...
function addCrewRow(){
    ...
    firstnameCELL.appendChild(createAnyTextTextBox("firstname_" + count, 10, "", "enter your first name"));
    lastnameCELL.appendChild(createAnyTextTextBox("lastname_" + count, 15, "", "enter your last name"));
