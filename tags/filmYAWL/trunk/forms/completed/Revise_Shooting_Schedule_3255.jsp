...
<td><input name='production' type='text' id='production' value="<%= rss.getProduction() %>" pattern="text" title="Enter Production."></td>
...
<tr>
	...
	<td colspan="3">
	<p>
	<textarea name="<% out.print("sd" + a + "_end");%>" cols="50" id="<% out.print("sd" + a + "_end");%>" pattern="any_text" title="Enter End of Day Notes."><%= sds.getEndDayNotes() %></textarea>
	</p></td>
	<td class="right">&nbsp;</td>
</tr>
<tr>
...
<tr><td colspan="3">
<!-- LOAD -->
<form method="post" action="Revise_Shooting_Schedule_3255.jsp?formType=load&workItemID=<%= request.getParameter("workItemID") %>&userID=<%= request.getParameter("userID") %>&sessionHandle=<%= request.getParameter("sessionHandle") %>&JSESSIONID=<%= request.getParameter("JSESSIONID") %>&submit=htmlForm" name="upform" enctype="MULTIPART/FORM-DATA">
