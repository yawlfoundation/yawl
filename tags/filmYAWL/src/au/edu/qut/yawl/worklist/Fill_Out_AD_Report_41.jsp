			...
			<tr><td>
				<table width="700" border="0" cellpadding="0" cellspacing="0" id="crew">
					<tbody>
			  		...
			  		<tr align="center" valign="top">
			  		  <td class="left">&nbsp;</td>
			  		  <td colspan="10" align="left"><input name="button400" type="button" onClick="addCrewRow();" value="Insert Row">			  		    <input name="button401" type="button" onClick="deleteCrewRow();" value="Delete Row"></td>
			  		  <td class="right">&nbsp;</td>
			  		</tr>
			  		<tr align="center" valign="top">
