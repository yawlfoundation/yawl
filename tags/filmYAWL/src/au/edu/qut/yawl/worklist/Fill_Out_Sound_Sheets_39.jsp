...
%>
			...
			<tr><td colspan="5">
				<table width="700" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td><strong>Production</strong></td><td><input name="production" type="text" id="production" value="<%=gi.getProduction()%>" size="20" readonly></td>
						<td><strong>Date</strong></td>
						<td><input name="date" type="text" id="date" value="<%=gi.getDate().getDay()+"-"+gi.getDate().getMonth()+"-"+gi.getDate().getYear()%>" size="20" readonly></td>
					...
					<tr>
						<td class="left" width="15">&nbsp; </td>
						<td><strong>Producer</strong></td><td><input name="producer" type="text" id="producer" value="<%=foss.getProducer()%>" size="20" readonly></td>
						<td><strong>Director</strong></td><td><input name="director" type="text" id="director" value="<%=foss.getDirector()%>" size="20" readonly></td>
						<td><strong>Shoot Day </strong></td><td><input name="shoot_day" type="text" id="shoot_day" value="<%=gi.getShootDayNo()%>" size="15" readonly></td>
						<td class="right" width="15">&nbsp;</td>
					</tr>
					<tr>
						<td class="left" width="15">&nbsp; </td>
						<td><strong>Editor</strong></td><td><input name="editor" type="text" id="editor" value="<%= foss.getEditor() %>" size="20" readonly></td>
						<td><strong>Sound Recordist</strong></td><td><input name="sound_recordist" type="text" id="sound_recordist" value="<%=foss.getSoundRecordist()%>" size="20" readonly></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td class="right" width="15">&nbsp;</td>
					</tr>
    		...
    		<tr><td width="168">
				<table width="700" border="0" cellpadding="0" cellspacing="0">
      				<tr align="left" valign="top"><td width="15" class="header-left">&nbsp;</td>
					...
					<% if (sity_l.getTechInfo() != null) {
						TechInfoType tity_l = sity_l.getTechInfo();
					%>
					<tr>
						<td width="15" rowspan="3" valign="top" class="left">&nbsp; </td>
						...
						<td width="15" rowspan="3" valign="top" class="right">&nbsp;</td>
					</tr>
					...
					<tr>
						<th width="15" align="left" class="left">&nbsp;</th>
						...
						<th width="15" align="left" class="right">&nbsp;</th>
					</tr>
					<tr>
						<td width="15" class="left">&nbsp;</td>
					...
					<tr>
						<th width="15" align="left" class="left">&nbsp;</th>
						<th height="30" align="center"><strong>Timecode Source</strong></th>
						<th height="30" align="center"><strong>Format Media</strong></th>
						<th height="30" align="center"><strong>Recorder</strong></th>
						<th height="30" align="center"><strong>Transfer To</strong></th>
						<th height="30" align="center"><strong>Camera Frame Rate </strong></th>
						<th width="15" align="left" class="right">&nbsp;</th>
			...
			<tr><td><table width="700" border="0" align="center" cellpadding="0" cellspacing="0" id="table1">
              <tbody>
                ...
                <%
					int a=0;
					if (sity_l.getSceneInfo().isEmpty() == false) {
