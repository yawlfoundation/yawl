...
function addChildRow(){
	...
	remarksCELL.appendChild(createTextArea("children_remarks_" + child_count, 15, 0, "", "Enter Remarks. [String Value]"));
}
...
function addCrewRow(){
	...
	remarksCELL.appendChild(createTextArea("crew_remarks_" + crew_count, 8, 0, "", "Enter Remarks. [String Value]"));
}
...
function addMealRow(){
	...
	remarksCELL.appendChild(createTextArea("meal_remarks_" + meal_count, 20, 0, "", "Enter Remarks. [String Value]"));
}
