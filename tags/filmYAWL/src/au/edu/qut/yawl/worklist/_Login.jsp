<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        ...
        %>
        <p><font color='red'><em>Your attempt at login failed.</em></font></p>
        <%
            }
        %>
        <p>The information you enter here must exactly match our records. <br/>
            Enter your userID and password.   <br/>
            If you are not a registered user please contact
