...
<%@ page import="org.yawlfoundation.sb.reviseshootingschedule.*"%>
...
<html>
<head>
<title>Revise Shooting Schedule</title>
	...
	if (MultipartFormDataRequest.isMultipartFormData(request)) 
	{
		...
		System.out.println("mrequest jsessionid: "+request.getParameter("JSESSIONID"));
	     ...
	     if ( (todo != null) && (todo.equalsIgnoreCase("upload")) )
	     {
            ...
            int endOfFile = result.indexOf("</ns2:Revise_Shooting_Schedule>");
		...
		//xml = "<?xml version='1.0' encoding='UTF-8'?><ns2:Revise_Shooting_Schedule xmlns:ns2='http://www.yawlfoundation.org/sb/reviseShootingSchedule' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' xsi:schemaLocation='http://www.yawlfoundation.org/sb/reviseShootingSchedule reviseShootingScheduleType.xsd '><production>new</production><shootingSchedule><lastUpdatedDate>2007-07-07</lastUpdatedDate><director>me</director><producer>you</producer><startDate>2006-06-06</startDate><scheduledFinish>2005-05-05</scheduledFinish><revisedFinish>2004-04-04</revisedFinish><scheduledShootingDays>20</scheduledShootingDays></shootingSchedule><totalScenes>0</totalScenes><totalPageTime><number>0</number><numerator>0</numerator></totalPageTime><originalTiming>12:00:00</originalTiming></ns2:Revise_Shooting_Schedule>";
		xml = (String)session.getAttribute("outputData");
		xml = xml.replaceAll("<Revise_Shooting_Schedule", "<ns2:Revise_Shooting_Schedule xmlns:ns2='http://www.yawlfoundation.org/sb/reviseShootingSchedule'");
		xml = xml.replaceAll("</Revise_Shooting_Schedule","</ns2:Revise_Shooting_Schedule");
		//System.out.println("outputData xml: "+xml+" --- ");
	}
	
	ByteArrayInputStream xmlBA = new ByteArrayInputStream(xml.getBytes());
	JAXBContext jc = JAXBContext.newInstance("org.yawlfoundation.sb.reviseshootingschedule");
	Unmarshaller u = jc.createUnmarshaller();
	JAXBElement rssElement = (JAXBElement) u.unmarshal(xmlBA);	//creates the root element from XML file	            
	ReviseShootingScheduleType rss = (ReviseShootingScheduleType) rssElement.getValue();
	ShootingScheduleType ss = rss.getShootingSchedule(); 
%>
...
<td>
	...
	<tr height="30">
		...
		<td><input name="production" type="text" id="production" value="<%= rss.getProduction() %>" pattern="any_text" title="Enter Production. [String Value]" readonly></td>
...
<table width="700" border="0" cellpadding="0" cellspacing="0" id="<% out.print("day" + a); %>">
	...
	<tr>
		...
		<td colspan="3" align="left"><textarea name="<% out.print("sd" + a + "_start");%>" id="<% out.print("sd" + a + "_start");%>" cols="60" title="Enter Start of Day Notes - If Necessary. [String Value]"><% if(sds.getStartDayNotes()!= null){ out.print(sds.getStartDayNotes());} %></textarea></td>
		<td class="right">&nbsp;</td>
	</tr>
	<tr>
		<td class="left">&nbsp;</td>
					...
					<td>
						<table border="0" cellpadding="0" cellspacing="0">
							...
							<tr>
                              ...
                              <td height="30" valign="top"><strong>Location ID </strong></td>
                              <td height="30" valign="top"><input name="<% out.print("sd" + a + "_locationID" + b);%>" type="text" id="<% out.print("sd" + a + "_locationID" + b);%>" value="<%= scs.getLocationID()%>" pattern="any_text" title="Enter Location ID. [String Value] (make sure it matches an id from location notes)"></td>
                              <td height="30" class="right">&nbsp;</td>
							  </tr>
							<tr>
                              <td height="30" class="left">&nbsp;</td>
                              <td height="30" valign="top"><strong>Address</strong></td>
                              <td height="30" colspan="3" valign="top"><input name="<% out.print("sd" + a + "_address" + b);%>" type="text" id="<% out.print("sd" + a + "_address" + b);%>" title="Enter Address. [String Value]" value="<%= scs.getAddress()%>" size="78" pattern="any_text"></td>
                              <td height="30" class="right">&nbsp;</td>
							  </tr>
							<tr>
                              <td height="30" class="left">&nbsp;</td>
                              <td height="30" valign="top"><strong>Synopsis</strong></td>
                              <td height="30" colspan="3" valign="top"><input name="<% out.print("sd" + a + "_synopsis" + b);%>" type="text" id="<% out.print("sd" + a + "_synopsis" + b);%>" title="Enter Synopsis. [String Value]" value="<%= scs.getSynopsis() %>" size="78" pattern="any_text"></td>
                              <td height="30" class="right">&nbsp;</td>
							  </tr>
							<tr>
								<td width="15" height="30" class="left">&nbsp;</td>
							...
							<tr>
								...
								<td height="15" colspan="3" valign="top">
									<table width="510" border="0" cellpadding="0" cellspacing="0" id="<% out.print("sd" + a + "_requirements" + b );%>">
										...
										<td><textarea name="<% out.print("sd" + a + "_requirements" + b + "_" + d);%>" id="<% out.print("sd" + a + "_requirements" + b + "_" + d);%>" cols="40" title="Enter Set Requirements. [String Value]"><%=se.getRequirements() %></textarea></td>
										</tr>
	...
	<tr>
		...
		<td colspan="3"><textarea name="<% out.print("sd" + a + "_end");%>" cols="60" id="<% out.print("sd" + a + "_end");%>" title="Enter End of Day Notes. [String Value]"><%= sds.getEndDayNotes() %></textarea></td>
		<td class="right">&nbsp;</td>
	</tr>
	<tr>
		<td class="left">&nbsp;</td>
...
<table width="700" border="0" cellpadding="0" cellspacing="0" id="day1">
	...
	<tr>
		<td class="left">&nbsp;</td>
		<td width="150" align="left"><strong>Start of Day Notes </strong></td>
		<td colspan="3" align="left"><textarea name="sd1_start" id="sd1_start" cols="60" title="Enter Start of Day Notes - If Necessary. [String Value]"></textarea></td>
		<td class="right">&nbsp;</td>
	</tr>
	<tr>
	<td class="left">&nbsp;</td>
	<td colspan="4" align="left">
		...
		<tr>
          ...
          <td height="30" valign="top"><strong>Location ID </strong></td>
          <td height="30" valign="top"><input name="sd1_locationID1" type="text" id="sd1_locationID1" value="" pattern="any_text" title="Enter Location ID. [String Value] (make sure it matches an id from location notes)"></td>
          <td height="30" class="right">&nbsp;</td>
		  </tr>
		<tr>
          <td height="30" class="left">&nbsp;</td>
          <td height="30" valign="top"><strong>Address</strong></td>
          <td height="30" colspan="3" valign="top"><input name="sd1_address1" type="text" id="sd1_address1" title="Enter Address. [String Value]" value="" size="78" pattern="any_text"></td>
          <td height="30" class="right">&nbsp;</td>
		  </tr>
		<tr>
          <td height="30" class="left">&nbsp;</td>
          <td height="30" valign="top"><strong>Synopsis</strong></td>
          <td height="30" colspan="3" valign="top"><input name="sd1_synopsis1" type="text" id="sd1_synopsis1" title="Enter Synopsis. [String Value]" value="" size="78" pattern="any_text"></td>
          <td height="30" class="right">&nbsp;</td>
		  </tr>
		<tr>
			<td width="15" height="30" class="left">&nbsp;</td>
		...
		<tr>
			...
			<td height="15" colspan="3" valign="top">
				<table width="510" border="0" cellpadding="0" cellspacing="0" id="sd1_requirements1"> 
					...
					<td><textarea name="sd1_requirements1_1" id="sd1_requirements1_1" cols="40" title="Enter Set Requirements. [String Value]"></textarea></td>
					</tr>
				</table>														
			</td>
			<td height="30" rowspan="2" class="right">&nbsp;</td>
	...
	<td colspan="3">
	<p>
	<textarea name="sd1_end" cols="60" id="sd1_end" title="Enter End of Day Notes. [String Value]"></textarea>
	</p></td>
	<td class="right">&nbsp;</td>
	</tr>
	<tr>
...
<tr><td colspan="3">
<!-- LOAD -->
<form method="post" action="Revise_Shooting_Schedule_3282.jsp?formType=load&workItemID=<%= request.getParameter("workItemID") %>&userID=<%= request.getParameter("userID") %>&sessionHandle=<%= request.getParameter("sessionHandle") %>&JSESSIONID=<%= request.getParameter("JSESSIONID") %>&submit=htmlForm" name="upform" enctype="MULTIPART/FORM-DATA">
...
if(request.getParameter("Submission") != null){
	...
	rss.setProduction(request.getParameter("production"));
	rss.setShootingSchedule(sst); 
	String total_scenes_string = Integer.toString(total_scenes);
	rss.setTotalScenes(new BigInteger(total_scenes_string));
	...
	rss.setOriginalTiming(XMLGregorianCalendarImpl.parse(original_timing));
	
	
	Marshaller m = jc.createMarshaller();
    m.setProperty( Marshaller.JAXB_FORMATTED_OUTPUT, Boolean.TRUE );
    File f = new File("./backup/ReviseShootingSchedule_"+new SimpleDateFormat("dd-MM-yyyy_hh-mm-ss").format(new Date())+".xml");
    m.marshal( rssElement,  f);//output to file
    
	ByteArrayOutputStream xmlOS = new ByteArrayOutputStream();
    m.marshal(rssElement, xmlOS);//out to ByteArray
	...
	response.setHeader("Content-Disposition", "attachment;filename=\"ReviseShootingSchedule_"+new SimpleDateFormat("dd-MM-yyyy_hh-mm-ss").format(new Date())+"_l.xml\";");
