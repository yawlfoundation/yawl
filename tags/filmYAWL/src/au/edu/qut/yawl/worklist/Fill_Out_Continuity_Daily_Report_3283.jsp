			...
			<tr>
				<td>
					<table width="700" border="0" cellspacing="0" cellpadding="0">
						...
						<tr height="30"><td colspan="6" class="bottom">&nbsp;</td></tr>
				  </table>
				</td>
			</tr>
			<%-- locations --%>
			<tr>
				<td>
					<table width="700" border="0" cellpadding="0" cellspacing="0" id="locations">
						<tbody>
							<tr valign="top">
								<th class="header-left">&nbsp;</th>
							  	<td colspan="2" class="header-middle">Locations</td>
							...
							<tr valign="top">
							  ...
							  <td><input name="location_address_<%=a%>" type="text" id="location_address_<%=a%>" size="70" value="<%=sl.getAddress() %>" ></td>
							  <td class="right">&nbsp;</td>
						  	</tr>
							<tr valign="top">
						...
						<tr valign="top"><th colspan="4" class="bottom">&nbsp;</th>
						</tr>
				  </table>
				</td>
			</tr>
					...
					<table width="700" border="0" cellpadding="0" cellspacing="0" id="slate_no">
					  ...
					  <%int c=0;
						...
						<tr valign="top">
						  ...
						  <td width="95"><input type="hidden" name="unit<%=c%>_count" id="unit<%=c%>_count" value="<%=d%>"/></td>
						  <th class="right">&nbsp;</th>
					  </tr>
					  <%}%>
					  </tbody>
...
if(request.getParameter("Submission") != null){
	...
	for(int current_unit=1; current_unit<=unit_count; current_unit ++) {	
		...
		for(int current_slate=1; current_slate<=slate_count; current_slate ++) {
			sut1.getSlate().add(request.getParameter("unit" + current_unit+ "_" + current_slate));
		}
