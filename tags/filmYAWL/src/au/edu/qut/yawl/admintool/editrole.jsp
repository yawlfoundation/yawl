...
<form method="post" action="http://131.181.70.9:8080/admintool/editServlet" name="deleteroles">
...
<table border="0" bgcolor="lightgrey"> 
<form method="post" action="http://131.181.70.9:8080/admintool/editServlet" name="deleteconnectedroles">
...
<table border="0" bgcolor="lightgrey"> 
<form method="post" action="http://131.181.70.9:8080/admintool/editServlet" name="deleteroleposition">
