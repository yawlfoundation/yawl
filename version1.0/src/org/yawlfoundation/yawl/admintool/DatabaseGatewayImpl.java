...
import org.yawlfoundation.yawl.admintool.model.*;
...
public class DatabaseGatewayImpl {
    ...
    public Resource[] getResourcesPerformingRole(String role) throws YPersistenceException {
        String userids = "";
        try {
            Query query = createQuery("from org.yawlfoundation.yawl.admintool.model.HumanResourceRole as hresrole where hresrole.Role = '" + role + "'");
    ...
    public List getWorkItemStatus(String specid) {
        ...
        try {
            ...
            String hql = "Select count(item._status),item._status from org.yawlfoundation.yawl.engine.YWorkItem as item group by item._status";
    ...
    public List getAverageSpecTimes(int timeformat, int granularity) {
        ...
        try {
            String hql = "Select yawlcase.created, yawlcase.completed,yawlcase.specification from org.yawlfoundation.yawl.logging.YCaseEvent as yawlcase";
            Query query = createQuery(hql);
            items = query.list();
	...
	try {
	    ...
	    System.out.println("rows: " + items.size());
	    for (int i = 0; i < items.size(); i++) {
		YChildWorkItemEvent caseinfo = (YChildWorkItemEvent) items.get(i);
		result.add(caseinfo);
	    }
	} catch (Exception e) {
	    e.printStackTrace();
    ...
    public List getCaseProcessingTime(String specid, int timeformat, int granularity) {
        ...
        try {
            String hql = "Select yawlcase.created, yawlcase.completed, yawlcase.identifier from org.yawlfoundation.yawl.logging.YCaseEvent as yawlcase";
    ...
    public String[] getSpecs() {
        ...
        String[] specids = null;
        try {
            String hql = "Select distinct yawlcase.specification from org.yawlfoundation.yawl.logging.YCaseEvent as yawlcase";
            Query query = createQuery(hql);
            items = query.list();
    ...
    public String[] getCases() {
        ...
        String[] caseids = null;
        try {
            String hql = "Select distinct yawlcase.identifier from org.yawlfoundation.yawl.logging.YCaseEvent as yawlcase";
            Query query = createQuery(hql);
            items = query.list();
	...
	String[] finallist = null;
	     ...
	     */
            String hql = "Select distinct yawlevent.resource from org.yawlfoundation.yawl.logging.YChildWorkItemEvent as yawlevent";
            Query query = createQuery(hql);
            items = query.list();
    ...
    public String[] getTasks() {
        ...
        String[] taskids = null;
        try {
            String hql = "Select distinct yawlevent.taskid from org.yawlfoundation.yawl.logging.YChildWorkItemEvent as yawlevent";
            Query query = createQuery(hql);
            items = query.list();
    ...
    public String[] getWorkItems() {
        ...
        try {
            String hql = "Select distinct yawlevent.identifier from org.yawlfoundation.yawl.logging.YChildWorkItemEvent as yawlevent";
            Query query = createQuery(hql);
            items = query.list();
