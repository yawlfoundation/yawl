                    ...
                    <ui:form binding="#{viewProfile.form1}" id="form1">
                        ...
                        <ui:panelLayout binding="#{viewProfile.pnlProfile}"
                            ...
                            <ui:label binding="#{viewProfile.lblName}"
                                      id="lblName" style="left: 18px; top: 12px; position: absolute"
                                      for="txtName"
                                      text="Name:"/>
                            ...
                            <ui:label binding="#{viewProfile.lblRoles}"
                                      id="lblRoles" style="left: 18px; top: 84px; position: absolute"
                                      for="cbbRoles"
                                      text="Roles:"/>
                            ...
                            <ui:label binding="#{viewProfile.lblPositions}"
                                      id="lblPositions" style="left: 18px; top: 120px; position: absolute"
                                      for="cbbPositions"
                                      text="Positions:"/>
                            ...
                            <ui:label binding="#{viewProfile.lblCapabilities}"
                                      id="lblCapabilities" style="left: 18px; top: 156px; position: absolute"
                                      for="cbbCapabilities"
                                      text="Capabilities:"/>
                        ...
                        <ui:panelLayout binding="#{SessionBean.messagePanel}"
                                        id="msgPanel"
                                        panelLayout="flow"
                                        style="position: absolute; left: 124px; top: 455px"/>
