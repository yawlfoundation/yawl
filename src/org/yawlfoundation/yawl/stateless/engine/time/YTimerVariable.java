...
public class YTimerVariable {
    ...
    private final YTask _ownerTask;
    ...
    public void setState(State state, boolean restoring) {
    ...
    public void setStateActive() { setState(State.active); }

    public void setStateClosed() { setState(State.closed); }

    public void setStateExpired() { setState(State.expired); }
