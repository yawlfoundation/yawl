...
public abstract class YDecomposition implements Cloneable, YVerifiable {
    ...
    private final Map<String, YParameter> _outputParameters;
    private final Set<String> _outputExpressions;
    protected Document _data;
    private YNetData _casedata = null;
    private final YAttributeMap _attributes;
    ...
    public void initializeDataStore(YNetData casedata) {
        _casedata = casedata;
