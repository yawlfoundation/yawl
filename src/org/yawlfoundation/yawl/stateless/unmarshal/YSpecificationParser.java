...
class YSpecificationParser {
    ...
    private final Namespace _yawlNS;
    private final List<String> _emptyComplexTypeFlagTypes = new ArrayList<>();
        ...
        if (isBeta2Version()) {
            ...
            for (int i = 1; i <= decompositionElems.size(); i++) {
                ...
                _decompositionParser[i] = new YDecompositionParser(
                        ...
                        this,
                        _specification.getSchemaVersion());
                org.yawlfoundation.yawl.stateless.elements.YDecomposition decomposition = _decompositionParser[i].getDecomposition();
