        ...
        if (isEnabled()) {
            ...
            if (query != null) {
                ...
                if (instances != null && !instances.isEmpty()) {
                    ...
                    for (Object o : instances) {
                        YLogDataItemInstance dataItem = (YLogDataItemInstance) o;
    ...
    public String getDataTypeForDataItem(long dataTypeKey) {
        ...
        if (isEnabled()) {
            ...
            if (query != null) {
                ...
                if (instances != null && !instances.isEmpty()) {
                    StringBuilder xml = new StringBuilder();
                    YLogDataType dataType = (YLogDataType) instances.getFirst();
        ...
        if (isEnabled()) {
            ...
            if (query != null) {
                ...
                if (instances != null && !instances.isEmpty()) {
                    ...
                    for (Object o : instances) {
                        YLogTaskInstance instance = (YLogTaskInstance) o;
                        xml.append(instance.toXML());
                    }
                    xml.append("</taskinstances>");
                    result = xml.toString();
    ...
    private YLogSpecification getSpecification(YSpecificationID specID) {
        if (isEnabled()) {
            ...
            if (query != null) {
                ...
                if (instances != null && !instances.isEmpty()) {
                    return (YLogSpecification) instances.getFirst();
                }
            }
        }
        return null;
