...
public class FastestToAllocate extends AbstractAllocator {

    public FastestToAllocate() {
        super() ;
        setName(this.getClass().getSimpleName()) ;
        setDisplayName("Fastest to Allocate") ;
        setDescription("The Fastest to Allocate allocator chooses the participant from " +
                       "the distribution set who, on average, has recorded the " +
                       "fastest time from item offer to allocating the item.");
    }
