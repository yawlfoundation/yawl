...
<p align="center"><img src="graphics/logo.jpg" width="58" height="57"></p>
<h1 align="center">Welcome to Porchlight Production Process</h1>
<form name="form1" method="post" onSubmit="return getCount(this)">
	<table width="900" border="0" align="center">
		...
		out.println("<tr><td><strong>Production</strong></td><td><input name='production' type='text' id='production' value='"+gi.getProduction()+"' readonly></td>");
		out.println("<td><strong>Date</strong></td><td><input name='date' type='text' id='date' value='"+gi.getDate().getDay()+"-"+gi.getDate().getMonth()+"-"+gi.getDate().getYear()+"' readonly></td>");
		...
		try {
			...
			out.println("<tr><td colspan='4'><table border='0'><tr><td>" + str + "</td></tr><tr><td><font size='2'>© Copyright Commonwealth of Australia 2007, Bureau of Meteorology (ABN 92 637 533 532)</td></tr></table></td>");
	...
	<td colspan='4'>
		<form name="map" action="#" onsubmit="showAddress(this.address.value); return false"><div id="map" style="width: 600px; height: 500px"></div></form>
		<form name="unit1" action="#" onsubmit="setMarker1(this.point1_lat.value, this.point1_lng.value); return false">
	  		<p align="center">Unit A <input type="text" size="20" id="point1_lat" name="point1_lat"/><input type="text" size="20" id="point1_lng" name="point1_lng"/><input type="submit" value="Set A" /></p>
		</form>
		<form name="unit2" action="#" onsubmit="setMarker2(this.point2_lat.value, this.point2_lng.value); return false">
	  		<p align="center">Unit B <input type="text" size="20" id="point2_lat" name="point2_lat"/><input type="text" size="20" id="point2_lng" name="point2_lng"/><input type="submit" value="Set B" /></p>
    	</form>
	</td></tr>
	<tr><td colspan="8">
  ...
  <p align="center"><input type="submit" name="Submission" value="Submission"></p>
</form>
