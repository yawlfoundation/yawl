...
<table width="1100" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td>
	<h1 align="center"><img src="graphics/logo.jpg" width="97" height="95"></h1>      
...
%>
			...
			<tr><td>
    			<table width="902" border="0" align="center" cellpadding="0" cellspacing="0" id="table1">
					<tbody>
						...
						<tr>
							<td width="15" align="left" class="leftbox">&nbsp;</td>
							...
							<td width="15" align="left" class="rightbox">&nbsp;</td>
						</tr>
					</tbody>
  		...
  		<p align="center"><input type="submit" name="Save" value="Save"/>
