...
function createEntry(){
	...
	addressCELL.appendChild(createAnyTextTextBox("address_" + count, 25, "", "Enter Location Address. [String Value]"));
	...
	policeCELL.appendChild(createAnyTextTextBox("police_" + count, 25,"", "Enter Police Details. [String Value]"));
	hospitalLABEL.appendChild(createBoldLabel("Hospital"));
	hospitalCELL.appendChild(createAnyTextTextBox("hospital_" + count, 25,"", "Enter Hospital Details. [String Value]"));
	...
	parkingCELL.appendChild(createAnyTextTextBox("parking_" + count, 80,"", "Enter Parking Instructions. [String Value]"));
	...
	unitCELL.appendChild(createAnyTextTextBox("unit_" + count, 80,"", "Enter Unit Instructions. [String Value]"));
