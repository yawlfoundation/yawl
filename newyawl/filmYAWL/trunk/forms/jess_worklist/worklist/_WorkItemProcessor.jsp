                ...
                <%
					...
					try{
						...
						if (request.getParameter("FormType").compareTo("Xform") == 0) {
							...
							response.sendRedirect(response.encodeURL(getServletContext().getInitParameter("HTMLForms")+"/"+form+"?userID="+userID+"&workItemID="+workItemID+"&sessionHandle="+sessionHandle+"&submit=htmlForm"));
