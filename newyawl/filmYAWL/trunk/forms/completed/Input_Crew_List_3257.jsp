				...
				<tbody>
				 ...
				 if (cit.getSingleCrewInfo().isEmpty() == false){
                  ...
                  <tr valign="top">
					...
					<td height="30" align="center"><input name='<% out.print("firstname_" + a); %>' type='text' id='<% out.print("firstname_" + a); %>' size="10" value="<%= scit.getFirstName() %>" pattern="any_text"></td>
				  ...
				  <tr valign="top">
					...
					<td height="30" align="center"><input name='firstname_1' type='text' id='firstname_1' size="10" value="" pattern="any_text" title="enter your first name"></td>
                    <td height="30" align="center"><input name='lastname_1' type='text' id='lastname_1' size="15" value="" pattern="any_text" title="enter your last name"></td>
                    ...
                    <td align="center"><input name='email_1' type='text' id='email_1' size="20" value="" pattern="email"></td>
                    <td width="15" height="30" class="right">&nbsp;</td>
                  </tr>
				  <%} } %>
			    </tbody>
