...
<table border="0"> 
<form method="post" action="http://131.181.70.9:8080/admintool/editServlet" name="selectresource">
...
<form method="post" action="http://131.181.70.9:8080/admintool/editServlet" name="editResource">
...
<table>
<form method="post" action="http://131.181.70.9:8080/admintool/editServlet" name="deleteResourceCapability">
...
<table>
<form method="post" action="http://131.181.70.9:8080/admintool/editServlet" name="deleteResourcePosition">
...
<table>
<form method="post" action="http://131.181.70.9:8080/admintool/editServlet" name="deleteResourceRole">
