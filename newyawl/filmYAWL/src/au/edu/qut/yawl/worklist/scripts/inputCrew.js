...
function addCrewRow(){
    ...
    roleCELL.appendChild(createAnyTextTextBox("role_" + count, 18, "", "Enter Role. [String Value]"));
    firstnameCELL.appendChild(createAnyTextTextBox("firstname_" + count, 10, "", "Enter First Name. [String Value]"));
    lastnameCELL.appendChild(createAnyTextTextBox("lastname_" + count, 14, "", "Enter Last Name. [String Value]"));
    contactnoCELL.appendChild(createAnyTextTextBox("contactno_" + count, 10, "", "Enter Contact Number. [String Value]"));
    emailCELL.appendChild(createEmailTextBox("email_" + count, 40, "", "Enter Email Address. [String Value]"));
}