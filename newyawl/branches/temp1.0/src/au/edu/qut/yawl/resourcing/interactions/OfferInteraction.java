...
public class OfferInteraction extends AbstractInteraction {
    ...
    private HashSet<ResourceFilter> _filters  = new HashSet<ResourceFilter>();
    private HashSet<ResourceConstraint> _constraints  = new HashSet<ResourceConstraint>();
    ...
    public void addParticipant(String id) {
        Participant p = new Participant(id);        // todo: change when db inf up
        _participants.add(p);
    }
    ...
    public void addRole(String role) {
        Role r = new Role(role);                         // todo: change when db inf up
        _roles.add(r) ;
    }
    ...
    public void addFilter(ResourceFilter f) {
        _filters.add(f);
    }
    ...
    public void addConstraint(ResourceConstraint c) {
        _constraints.add(c);
    }
    ...
    public Set<Participant> performOffer(WorkItemRecord wir) {
        ...
        if (_familiarParticipantTask != null) {
            ...
            distributionSet = _participants ;                 // start with participants
            ...
            for (ResourceConstraint constraint : _constraints)
                distributionSet =
        ...
        if (e != null) {
            ...
            while (itr.hasNext()) {
                ...
                if (filterClassName != null) {
                    ResourceFilter filter = FilterFactory.getInstance(filterClassName);
                    if (filter != null) {
    ...
    public String toXML() {
        ...
        if (_roles != null) {
            ...
            while (itr.hasNext()) {
                ...
                xml.append("<role>").append(r.getName()).append("</role>");
            }
        }
        if (_dynParams != null) {
        ...
        if (_filters != null) {
            ...
            while (itr.hasNext()) {
                ResourceFilter filter = (ResourceFilter) itr.next();
        ...
        if (_constraints != null) {
            ...
            while (itr.hasNext()) {
                ResourceConstraint constraint = (ResourceConstraint) itr.next();
    ...
    /*******************************************************************************/
        ...
        public Set<Participant> evaluate(WorkItemRecord wir) {
            ...
            if (_refers == USER_PARAM)
                result.add(_rm.getParticipant(varID)) ;
            else
                result.addAll(_rm.getRoleParticipants(varID)) ;
