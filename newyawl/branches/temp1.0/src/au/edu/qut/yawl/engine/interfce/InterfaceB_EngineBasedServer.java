...
public class InterfaceB_EngineBasedServer extends HttpServlet {
    ...
    private String processGetQuery(HttpServletRequest request) {
        ...
        try {
            ...
            // unmask the '&' in any param values
       //     Interface_Client.unmaskAmps(request.getParameterMap()) ;
            ...
            if (!"ib".equals(lastPartOfPath)) {
                if ("connect".equals(lastPartOfPath)) {
                    ...
                    if ("checkout".equals(action)) {
                        ...
                        String data = Interface_Client.unmaskAmps(request.getParameter("data"));
                        ...
                        String caseParams = Interface_Client.unmaskAmps(request.getParameter("caseParams"));
