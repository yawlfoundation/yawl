         ...
         try {
            ...
            if (result != null && successful(result)) {
                ...
                while (itr.hasNext()) {
                    ...
                    constraints.add(AbstractConstraint.unmarshal(elConstraint));
                }
            }
        }
        catch (IOException e) {
         ...
         try {
            ...
            if (result != null && successful(result)) {
                ...
                while (itr.hasNext()) {
                    ...
                    filters.add(AbstractFilter.unmarshal(elFilter));
                }
            }
        }
        catch (IOException e) {
         ...
         try {
            ...
            if (result != null && successful(result)) {
                ...
                while (itr.hasNext()) {
                    ...
                    allocators.add(AbstractAllocator.unmarshal(elAllocator));
                }
            }
        }
        catch (IOException e) {
