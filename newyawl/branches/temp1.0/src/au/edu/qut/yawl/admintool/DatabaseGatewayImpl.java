...
public class DatabaseGatewayImpl {
	...
	String[] finallist = null;
	     ...
	     */
            String hql = "Select distinct yawlevent.resource from au.edu.qut.yawl.logging.YWorkItemEvent as yawlevent";
            Query query = createQuery(hql);
            items = query.list();
    ...
    public String[] getTasks() {
        ...
        String[] taskids = null;
        try {
            String hql = "Select distinct yawlevent.taskid from au.edu.qut.yawl.logging.YWorkItemEvent as yawlevent";
            Query query = createQuery(hql);
            items = query.list();
    ...
    public String[] getWorkItems() {
        ...
        try {
            String hql = "Select distinct yawlevent.identifier from au.edu.qut.yawl.logging.YWorkItemEvent as yawlevent";
            Query query = createQuery(hql);
            items = query.list();
