...
public class AllocatorFactory {
     ...
     */
    public static ResourceAllocator getInstance(String allocatorName) {
        try {
			ResourceAllocator newClass = (ResourceAllocator)
     ...
     * @return the instantiated class, or null if there was a problem
     */
    public static ResourceAllocator getInstance(String allocatorName, HashMap params) {
        ResourceAllocator newClass = getInstance(allocatorName);
...
//        String[] classes = new File(".").list(new AllocatorClassFileFilter());
        String[] classes = new
                File("./classes/au/edu/qut/yawl/resourcing/allocators").list(
                new AllocatorClassFileFilter());
        ...
        for (String aClass : classes) {
            ...
            ResourceAllocator temp = getInstance(sansExtn);
    ...
    private static class AllocatorClassFileFilter implements FilenameFilter {
        ...
        public boolean accept(File dir, String name) {
            if (( new File(dir, name).isDirectory() ) ||        // ignore dirs
                ...
                (name.startsWith("ResourceAllocator")))         // and the base classes
                return false;
