...
//
        ...
        Element eConstraints = resClient.getConstraints(handle);
        Element eFilters = resClient.getFilters(handle);
        Element eAllocators = resClient.getAllocators(handle);

        // get full sets of Org Data
        Element eParticipants = resClient.getParticipants(handle);
        Element eRoles = resClient.getRoles(handle);
        Element eCapabilities = resClient.getCapabilities(handle);
        Element ePositions = resClient.getPositions(handle);
        Element eOrgGroups = resClient.getOrgGroups(handle);
