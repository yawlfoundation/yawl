<%@ page import="org.yawlfoundation.yawl.worklist.model.WorkListGUIUtils,
                 java.io.*,
                 org.yawlfoundation.yawl.engine.interfce.Marshaller"%><html
    ...
    if(beginOfFile != -1 && endOfFile != -1){
        ...
        if(sessionHandle != null && mayAdminister){
            ...
            <table border="0" cellspacing="10" bgColor="LightGrey">
                <font color="red">  There was a problem uploading your specification.</font>
                <%= htmlErr %>
            </table>
            <%
        } else {
