package org.yawlfoundation.yawl.resourcing.autoresource;
...
public class XQueryEvaluator {
    ...
    public Element evaluate() throws AutoResourceEvaluationException,
                                     YStateException, YQueryException {
        if (_outputs == null) {
           String msg = "Cannot perform evaluation: Missing or empty output parameter list.";
           throw new AutoResourceEvaluationException(msg) ;
        }
    ...
    private Element evaluateQuery(String query, Document dataDoc)
               throws AutoResourceEvaluationException, YStateException, YQueryException {
        ...
        try {
            ...
            if (nodeInfo != null) {
                ...
                throw new AutoResourceEvaluationException("No data produced.");
            }
        }
            ...
            if (e instanceof AutoResourceEvaluationException)
                throw (AutoResourceEvaluationException) e;
