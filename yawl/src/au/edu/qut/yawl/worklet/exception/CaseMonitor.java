...
public class CaseMonitor {
    ...
    public CaseMonitor(String specID, String caseID, String data) {
        ...
        _itemRunners = new HashMap<String, HandlerRunner>() ;
        _liveCase = true ;
        _caseDataStr = data;
        _netDataStr = data;
   }
     ...
     */
    public List<HandlerRunner> restoreRunners(HashMap runnerMap) {
        ArrayList<HandlerRunner> restored = new ArrayList<HandlerRunner>() ;
        _itemRunners = new HashMap<String, HandlerRunner>();  // runners at the item level
    ...
    public ArrayList<HandlerRunner> getHandlerRunners() {
        ArrayList<HandlerRunner> list = new ArrayList<HandlerRunner>();
    ...
    public String toString() {
        ...
        String netData = (_netLevelData == null)? "null" : JDOMConversionTools.elementToString(_netLevelData);              // case-level decl. data params
