    ...
    private String[] tokenize(String s) throws RDRConditionException {
    	...
    	while (ix < ln) {
    		...
    		if (s.charAt(ix) == '"') {                     // literal string
	   		...
	   		else if (isLetterOrUScore(s.charAt(ix))) {      // var name
   	...
   	/** returns a variable name from start position in expression */
...
//==========================================================================//    
   ...
   /** retrieves the value for a variable from the datalist Element */
   private String getVarValue(String var) {
   	   String result = _dataList.getChildText(var) ;
