...
public class PDFHandler extends HttpServlet
{
    ...
    //private InterfaceD_Client idclient = new InterfaceD_Client("http://localhost:8080/PDFforms/interfaceD");
	...
	private void processPDF(String filename) throws javax.servlet.ServletException, java.io.IOException {
		...
		*/
		...
		try {
		    ...
		    //InterfaceD_Client.executePost("http://localhost:8080/PDFforms/interfaceD" + "", queryMap);
