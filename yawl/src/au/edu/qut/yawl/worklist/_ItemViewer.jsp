<%@ page import="au.edu.qut.yawl.worklist.model.WorkItemRecord,
                 au.edu.qut.yawl.worklist.model.TaskInformation"%><html
xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        ...
        <%
           	...
           	%>
           	<br>
           	<font color="red"><center>You have been sent to this page because an error occurred during form generation.</center></font>
           	<br><br>
           	<%
           	}
