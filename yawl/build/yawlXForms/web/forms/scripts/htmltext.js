...
function initalizeStyledTextarea (textarea) {
    if(textarea.id && _hasClass(textarea, "mediatype-text-html")) {
        ...
        dojo.debug("[StyledTextarea] Initialize "+textarea.id+" ("+textarea.name+")");
...
function _styledTextareaSetInnerHTML (textarea, value) {
    ...
    if( editorInstance != null && editorInstance.Status != FCK_STATUS_NOTLOADED) {
        ...
        dojo.debug("[StyledTextarea] SetInnerHTML STATUS "+textarea.id+" : "+editorInstance.Status);
        if(document.all) {
        ...
        dojo.debug("[StyledTextarea] Deferring SetInnerHTML : "+textarea.id);
    }
}
...
function _styledTextareaDeferredSetXFormsValue(editorInstance) {
    dojo.debug("[StyledTextarea] DeferredSetXFormsValue : "+ editorInstance.Name);
...
function FCKeditor_OnComplete(editorInstance) {
    dojo.debug("[StyledTextarea] Initialization completed : "+ editorInstance.Name);
    var textareaID = editorInstance.Name;
