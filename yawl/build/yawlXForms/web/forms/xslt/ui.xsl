...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template name="processMinimalPrototype">
        ...
        <div id="{$id}-prototype" class="repeat-prototype enabled readonly required valid">
            <xsl:apply-templates/>
        </div>
    </xsl:template>
    ...
    <xsl:template name="processFullPrototype">
        ...
        <xsl:call-template name="group-body">
            ...
            <xsl:with-param name="group-classes" select="'repeat-prototype enabled readonly required valid'"/>
        </xsl:call-template>
    </xsl:template>
