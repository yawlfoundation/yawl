 ...
 *
 */
public class FtpServiceData extends NexusServiceData {
	...
	public FtpServiceData(NexusServiceData data) throws IOException, ClassNotFoundException {
		this();
		for (Column column: Column.values()) {
