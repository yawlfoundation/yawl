 ...
 */
public class ConfigurationEditor extends ComponentEditor {
	private static final Log LOG = LogFactory.getLog( ConfigurationEditor.class );
...
//        messagePanel.setLayout( new BoxLayout( messagePanel, BoxLayout.Y_AXIS ) );
		...
		_fileBrowseButton.addActionListener( new ActionListener() {
			public void actionPerformed( ActionEvent e ) {
				...
				int returnVal = fc.showOpenDialog( ConfigurationEditor.this );
