...
import org.yawlfoundation.yawl.engine.interfce.AggregatedWorkItemRecord;
...
//                             */
//                            ylog.get_eventTime()(ylog.getCompleted()-ylog.getCreated());
...
//
//                    YChildWorkItemEvent dummy_event = new YChildWorkItemEvent();
...
//                    for (int j = 0; j < resultlist.size();j++) {
//
//                        YChildWorkItemEvent event = (YChildWorkItemEvent) resultlist.get(j);
//
    ...
    public String buildInitialQuery(HttpServletRequest req) {
        ...
        if (element!=null) {
            if (element.equals("Cases")) {
                querystartstring = new String("Select distinct from org.yawlfoundation.yawl.logging.YCaseEvent as element");
                querytype = "case";
                querylist = new CommonQuery(req.getParameter("queryname"));
            } else {
                querystartstring = new String("Select distinct from org.yawlfoundation.yawl.logging.YChildWorkItemEvent as element");
                querytype = "task";
                querylist = new CommonQuery(req.getParameter("queryname"));
            }
        }
