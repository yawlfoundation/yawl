...
public class SetSelectedElementsFillColourAction extends YAWLSelectedNetAction
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        Color newColor = JColorChooser.showDialog(
                ...
                getColorOfFirstSelectedVertex(selected)
        );
        if (newColor != null) {
            ...
            YAWLEditor.getPropertySheet().firePropertyChange(
    ...
    private Color getColorOfFirstSelectedVertex(Object[] selected) {
        for (Object o : selected) {
            YAWLVertex vertex = getSelectedVertexIfAppropriate(o);
            if (vertex != null) {
                return vertex.getBackgroundColor();
            }
        }
        return UserSettings.getVertexBackgroundColour();       // default
    }
