...
public class AlignLeftAction extends YAWLSelectedNetAction implements TooltipTogglingWidget, SpecificationSelectionSubscriber  {
    ...
    
  {
    ...
    putValue(Action.SMALL_ICON, getPNGIcon("shape_align_left"));
  ...
  public void actionPerformed(ActionEvent event) {
    ...
    if (graph != null) {
      NetCellUtilities.alignCellsAlongLeft(graph, graph.getSelectionCells());
    }
  }
