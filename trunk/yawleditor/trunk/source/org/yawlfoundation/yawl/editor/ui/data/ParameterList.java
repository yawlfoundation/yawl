...
public class ParameterList implements Cloneable {
  ...
  public void add(int position, DataVariable variable, String query) {
    ...
    _parameters.add(position, parameter);
    parameter.setList(this);
  }
  ...
  public void remove(DataVariable variable) {
    ...
    if (! toRemove.isEmpty()) _parameters.removeAll(toRemove);
  }
  ...
  public DataVariable getVariableAt(int position) {
    return _parameters.get(position).getVariable();
  }

  public String  getVariableNameAt(int position) {
    return _parameters.get(position).getVariable().getName();
  }
  ...
  public String getQueryAt(int position) {
    return _parameters.get(position).getQuery();
  }
  ...
  public Parameter getParameterAt(int position) {
    return (Parameter) _parameters.get(position);
  }
