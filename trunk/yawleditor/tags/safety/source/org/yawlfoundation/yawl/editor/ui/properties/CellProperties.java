...
public class CellProperties extends NetProperties {
    ...
    public String getId() { return vertex.getEngineId(); }         // read only
    ...
    public void setLabel(String value) {
        ...
        vertex.setEngineLabel(value);
        if (idLabelSynch && value != null) {
            vertex.setEngineID(new EngineIdentifier(value));
        }
    ...
    public void setIdLabelSynch(boolean value) {
        ...
        if (idLabelSynch && getLabel() != null) {
            vertex.setEngineID(new EngineIdentifier(getLabel()));
            setDirty();
        }
    }
    ...
    public String getCustomForm() {
        return ((YAWLTask) vertex).getCustomFormURL();
    }
    ...
    public TaskTimeoutDetail getTimer() {
        return ((AtomicTask) vertex).getTimeoutDetail();
    }

    public void setTimer(TaskTimeoutDetail value) {
        ((AtomicTask) vertex).setTimeoutDetail(value);
    }
    ...
    public String getDecomposition() {
        Decomposition decomposition = ((YAWLTask) vertex).getDecomposition();
        String label = decomposition != null ? decomposition.getLabel() : "None";
    ...
    public void setDecomposition(String name) {
        ...
        else if (decomposition == null || ! decomposition.getLabel().equals(name)) {
    ...
    private Decomposition createDecomposition(Decomposition current) {
        ...
        if (! StringUtil.isNullOrEmpty(newName)) {
            WebServiceDecomposition newDecomposition = new WebServiceDecomposition(newName);
            SpecificationModel.getInstance().addWebServiceDecomposition(newDecomposition);
