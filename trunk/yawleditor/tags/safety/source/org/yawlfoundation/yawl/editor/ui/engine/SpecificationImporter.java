...
public class SpecificationImporter extends EngineEditorInterpretor {
  ...
  private static void setTaskTimers(YAtomicTask engineTask, YAWLAtomicTask editorTask,
      ...
      if (timeParams != null) {
          TaskTimeoutDetail timeoutDetail = new TaskTimeoutDetail(editorTask);
          ...
          if (netParam != null) {
              ...
              if (expiry != null) {
                  timeoutDetail.setValue(expiry);
              }
              else {
                  Duration duration = (Duration) timeParams.get("duration");
                  if (duration != null) {
                      timeoutDetail.setValue(duration.toString());
                  }
              }
          }
