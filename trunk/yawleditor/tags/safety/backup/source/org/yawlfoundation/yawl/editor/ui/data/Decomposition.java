...
public class Decomposition {
    ...
    public Decomposition(String id) {
        if (SpecificationModel.getInstance().isLoadInProgress()) {
            _decomposition = SpecificationModel.getHandler().getTaskDecomposition(id);
        }
        else {
            _decomposition = SpecificationModel.getHandler().addTaskDecomposition(id);
        }
        setVariables(new DataVariableSet());
    }

    public Decomposition(boolean isRootNet) {
        YSpecificationHandler spec = SpecificationModel.getHandler();
