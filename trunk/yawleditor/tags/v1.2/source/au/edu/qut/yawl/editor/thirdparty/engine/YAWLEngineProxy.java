...
public class YAWLEngineProxy implements YAWLEngineProxyInterface {
  ...
  public String validateSimpleSchemaInstance(String typeDefinition, String schemeInstance) {
    return implementation.validateSimpleSchemaInstance(typeDefinition, schemeInstance);
  }
  
  public String validateComplexSchemaInstance(String variableName, String typeDefinition, String schemeInstance) {
    return implementation.validateComplexSchemaInstance(variableName, typeDefinition, schemeInstance);
  }
