...
public class InstanceSchemaValidator extends DefaultHandler {
    ...
    public String validateSimpleInstance(String simpleTypeDefinition, String simpleTypeInstance) {
    ...
    public String validateComplexInstance(String variableName, String complexType, String complexTypeInstance) {

      String schema = YAWLEngineProxy.getInstance().createSchemaForVariable(
          variableName, complexType
      );

      String result = validateWrappedInstance(schema, complexTypeInstance);
      result = groomLineNumbers(result);
    ...
    private String getInstanceCheckResults(String schema, String instance) {
      ...
      elementSchema = new File(userDir, "_elementSchema.xsd");
      try {
