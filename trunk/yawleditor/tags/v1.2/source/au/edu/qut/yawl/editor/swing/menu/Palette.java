...
import au.edu.qut.yawl.editor.swing.YAWLPaletteButton;
...
public class Palette extends YAWLToolBar implements SpecificaitonModelListener {
  ...
  private static YAWLPaletteButton[] buttons = {
    new YAWLPaletteButton(new AtomicTaskAction()),
    new YAWLPaletteButton(new CompositeTaskAction()),
    new YAWLPaletteButton(new MultipleAtomicTaskAction()),
    new YAWLPaletteButton(new MultipleCompositeTaskAction()),
    new YAWLPaletteButton(new FlowRelationAction()),
    new YAWLPaletteButton(new ConditionAction()),
    new YAWLPaletteButton(new MarqueeAction()),
  };
