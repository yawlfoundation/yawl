...
public class ViewingCancellationSetAction extends YAWLBaseAction 
...

  {
    ...
    putValue(Action.NAME, "Viewing my Cancellation Set");
...
//    putValue(Action.SMALL_ICON, getIconByName("Blank"));
  ...
  public ViewingCancellationSetAction(YAWLTask task, NetGraph graph) {
    super();
    this.task = task;
    this.graph = graph;
  }
