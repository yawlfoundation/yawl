...
public class TestXMLUtilities extends TestCase {
  ...
  public void testToValidElementName() {
    ...
    convertedString = XMLUtilities.toValidElementName("New Net #1");
  	assertEquals(convertedString, "New_Net_1");

    convertedString = XMLUtilities.toValidElementName("   New Net #2   ");
    assertEquals(convertedString, "___New_Net_2___");
    
    convertedString = XMLUtilities.toValidElementName("!@#$^&*$%^&*()_123!@#$!#@!!%&*");
    assertEquals(convertedString, "_123");

    convertedString = XMLUtilities.toValidElementName("!@#$^&*$%^&*().123!@#$!#@!!%&*");
    assertEquals(convertedString, ".123");
    
    convertedString = XMLUtilities.toValidElementName("!@#$^&*$%^&*()-123!@#$!#@!!%&*");
    assertEquals(convertedString, "-123");
    
    convertedString = XMLUtilities.toValidElementName("!@#$");
    assertEquals(convertedString, "");
  }
  
  public void testQuoteSpecialCharacters() {
    String convertedString;
    
    convertedString = XMLUtilities.quoteSpecialCharacters("\"blah\"");
    assertEquals(convertedString, "&quot;blah&quot;");
