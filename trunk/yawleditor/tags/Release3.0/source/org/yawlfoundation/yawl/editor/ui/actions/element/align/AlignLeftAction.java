...
public class AlignLeftAction extends YAWLSelectedNetAction implements TooltipTogglingWidget, GraphStateListener {
    ...
    
  {
    ...
    putValue(Action.SMALL_ICON, getMenuIcon("shape_align_left"));
