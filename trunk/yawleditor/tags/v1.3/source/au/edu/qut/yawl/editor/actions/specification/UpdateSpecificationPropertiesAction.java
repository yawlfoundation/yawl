...
import au.edu.qut.yawl.editor.swing.JFormattedSelectField;
...
class UpdateSpecificationPropertiesDialog extends AbstractDoneDialog {
  ...
  private JTextField specificationNameField;
  private JTextField specificationDescriptionField;
  private JTextField specificationAuthorField;
  ...
  private JTextField getSpecificationIDField() {
  ...
  private JTextField getSpecificationNameField() {
    specificationNameField = new JFormattedSelectField(20);
    specificationNameField.setToolTipText(" Enter a human-friendly name for this specification ");
    return specificationNameField;
  }
  
  private JTextField getSpecificationDescriptionField() {
    specificationDescriptionField = new JFormattedSelectField(40);
  ...
  private JTextField getSpecificationAuthorField() {
    specificationAuthorField = new JFormattedSelectField(20);
    specificationAuthorField.setToolTipText(" Enter the author's name for this specification ");
    return specificationAuthorField;
  }
  
  private JTextField getVersionNumberField() {
  ...
  public TimeStampPanel() {
   ...
   public void setTimestamp(String timestamp) {
     if (timestamp == null || timestamp.trim().equals("")) {
       ...
       String dateTimestamp = timestamp.substring(0,8);

       dateField.setDateViaTimestamp(dateTimestamp);

       timestampButton.setSelected(true);
     }
