...
*/  
  ...
  private void parseRawStructureIssuesIntoList(List resultsList, String rawStructureIssues) {
    parseRawWarningsIntoList("Structural Warning:  ", resultsList, rawStructureIssues);
  }
  ...
  private void parseRawBehaviouralIssuesIntoList(List resultsList, String rawStructureIssues) {
    parseRawWarningsIntoList("Behavioural Warning: ", resultsList, rawStructureIssues);
  }
