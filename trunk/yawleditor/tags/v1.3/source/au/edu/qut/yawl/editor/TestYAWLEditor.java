...
public class TestYAWLEditor extends TestCase {
  ...
  private static void addMicroSuite(TestSuite parentSuite) {
    ...
    parentSuite.addTest(au.edu.qut.yawl.editor.swing.TestJXMLSchemaEditorPane.suite()); 
    parentSuite.addTest(au.edu.qut.yawl.editor.swing.TestJXMLSchemaInstanceEditorPane.suite()); 
  }
