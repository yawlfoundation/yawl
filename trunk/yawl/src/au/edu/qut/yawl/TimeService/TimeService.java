    ...
    public void handleEnabledWorkItemEvent(WorkItemRecord workItemRecord) {
        try {
            ...
            if (!successful(_sessionHandle)) {
                report = _sessionHandle;
                System.out.println("Unsuccessful");
            } else {
                String result = checkOut(workItemRecord.getID(), _sessionHandle);
                ...
                if (!successful(result)) {
                    ...
                    for (int i = 0; i < children.size(); i++) {
                        ...
                        if (notifytime != null && !notifytime.equals("")) {
                            ...
                            try {
                                int notify = new Integer(notifytime).intValue();
                            ...
                            report = workItemRecord.getTaskID();
