...
//===========================================================================//
     ...
     */  	
   	public static void log(String event, String caseId, String specId,
    	...
    	s.append(caseId); s.append(",") ;
   		...
   		try {
			...
			elog.error("Exception writing to EventLog", e);
		}        	       
    }
...
//===========================================================================//
     ...
     */  
    public static void log(String event, WorkItemRecord wir) {
    	log(event, wir.getCaseID(), wir.getSpecificationID(),
    	                                          wir.getTaskID(), "");
    }
