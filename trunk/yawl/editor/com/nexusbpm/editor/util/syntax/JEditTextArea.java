 ...
 *
 * @author Slava Pestov
 * @version $Id: JEditTextArea.java,v 1.4 2005/05/18 19:40:54 mfriedma Exp $
 */
public class JEditTextArea extends JComponent
{
	...
	public final void removeCaretListeners()
	{
		if (null != listenerList) {
			Object[] listeners = listenerList.getListenerList();
			for(int i = listeners.length - 2; i >= 0; i--)
			{
				if(listeners[i] instanceof CaretListener)
				{
					listenerList.remove(CaretListener.class, (CaretListener)listeners[i]);
				}
			}
		}
	}
