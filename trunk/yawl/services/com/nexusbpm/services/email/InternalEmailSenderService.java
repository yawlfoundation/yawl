 ...
 * @author Nathan Rose
 */
public class InternalEmailSenderService extends InternalNexusService {
	private static final Log LOG = LogFactory.getLog( InternalEmailSenderService.class );
	 ...
	 */
	public InternalEmailSenderService() {
	}
