    ...
    protected static SessionFactory initialise(boolean journalising) throws YPersistenceException {
        ...
        if (journalising) {
            try {
                ...
                cfg.addClass(au.edu.qut.yawl.logging.YParentWorkItemEvent.class);
                cfg.addClass(au.edu.qut.yawl.logging.YChildWorkItemEvent.class);
