            ...
            <ui:html binding="#{userWorkQueues.html1}" id="html1">
                ...
                <ui:body binding="#{userWorkQueues.body1}" id="body1" style="-rave-layout: grid">
                    <ui:form binding="#{userWorkQueues.form1}" id="form1">
                        <ui:tabSet binding="#{userWorkQueues.tabSet}" id="tabSet" selected="tabAllocated" style="border-width: 1px; border-style: solid; border-color: rgb(0, 0, 0) rgb(0, 0, 0) rgb(0, 0, 0) rgb(0, 0, 0); height: 262px; left: 168px; top: 150px; position: absolute; width: 694px">
                            <ui:tab action="#{userWorkQueues.tabOffered_action}" binding="#{userWorkQueues.tabOffered}" id="tabOffered" style="" text="Offered">
                            ...
                            <ui:tab action="#{userWorkQueues.tabAllocated_action}" binding="#{userWorkQueues.tabAllocated}" id="tabAllocated" text="Allocated">
                            ...
                            <ui:tab action="#{userWorkQueues.tabStarted_action}" binding="#{userWorkQueues.tabStarted}" id="tabStarted" text="Started">
                            ...
                            <ui:tab action="#{userWorkQueues.tabSuspended_action}" binding="#{userWorkQueues.tabSuspended}" id="tabSuspended" text="Suspended">
                        ...
                        <div style="height: 70px; left: 282px; top: 24px; position: absolute; width: 340px">
