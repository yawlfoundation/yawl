...
import au.edu.qut.yawl.logging.YChildWorkItemEvent;
...
public class DatabaseGatewayImpl {
    ...
    public List getAverageSpecTimes(int timeformat, int granularity) {
        ...
        try {
            String hql = "Select yawlcase.created, yawlcase.completed,yawlcase.specification from au.edu.qut.yawl.logging.YCaseEvent as yawlcase";
            Query query = createQuery(hql);
            items = query.list();
    ...
    public List getCaseProcessingTime(String specid, int timeformat, int granularity) {
        ...
        try {
            String hql = "Select yawlcase.created, yawlcase.completed, yawlcase.identifier from au.edu.qut.yawl.logging.YCaseEvent as yawlcase";
    ...
    public String[] getSpecs() {
        ...
        String[] specids = null;
        try {
            String hql = "Select distinct yawlcase.specification from au.edu.qut.yawl.logging.YCaseEvent as yawlcase";
            Query query = createQuery(hql);
            items = query.list();
    ...
    public String[] getCases() {
        ...
        String[] caseids = null;
        try {
            String hql = "Select distinct yawlcase.identifier from au.edu.qut.yawl.logging.YCaseEvent as yawlcase";
            Query query = createQuery(hql);
            items = query.list();
	...
	String[] finallist = null;
	     ...
	     */
            String hql = "Select distinct yawlevent.resource from au.edu.qut.yawl.logging.YChildWorkItemEvent as yawlevent";
            Query query = createQuery(hql);
            items = query.list();
    ...
    public String[] getTasks() {
        ...
        String[] taskids = null;
        try {
            String hql = "Select distinct yawlevent.taskid from au.edu.qut.yawl.logging.YChildWorkItemEvent as yawlevent";
            Query query = createQuery(hql);
            items = query.list();
    ...
    public String[] getWorkItems() {
        ...
        try {
            String hql = "Select distinct yawlevent.identifier from au.edu.qut.yawl.logging.YChildWorkItemEvent as yawlevent";
            Query query = createQuery(hql);
            items = query.list();
