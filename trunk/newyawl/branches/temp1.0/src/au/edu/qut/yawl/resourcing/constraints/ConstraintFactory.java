...
public class ConstraintFactory {
     ...
     */
    public static ResourceConstraint getInstance(String constraintName) {
        try {
			ResourceConstraint newClass = (ResourceConstraint)
     ...
     * @return the instantiated class, or null if there was a problem
     */
    public static ResourceConstraint getInstance(String constraintName, HashMap params) {
        ResourceConstraint newClass = getInstance(constraintName);
    ...
    public static Set getConstraints() {
       ...
       // String[] classes = new File(".").list(new ConstraintClassFileFilter());
        String[] classes = new File("./classes/au/edu/qut/yawl/resourcing/constraints").list(
                           new ConstraintClassFileFilter());
        ...
        for (String aClass : classes) {
            ...
            ResourceConstraint temp = getInstance(sansExtn);
    ...
    private static class ConstraintClassFileFilter implements FilenameFilter {
        ...
        public boolean accept(File dir, String name) {
            if (( new File(dir, name).isDirectory() ) ||        // ignore dirs
                ...
                (name.startsWith("ResourceConstraint")))        // and the base classes
                return false;
