    ...
    public String buildInitialQuery(HttpServletRequest req) {
        ...
        if (element!=null) {
            if (element.equals("Cases")) {
                querystartstring = new String("Select distinct from au.edu.qut.yawl.logging.YCaseEvent as element");
                querytype = "case";
                querylist = new CommonQuery(req.getParameter("queryname"));
            } else {
                querystartstring = new String("Select distinct from au.edu.qut.yawl.logging.YChildWorkItemEvent as element");
                querytype = "task";
                querylist = new CommonQuery(req.getParameter("queryname"));
            }
        }
