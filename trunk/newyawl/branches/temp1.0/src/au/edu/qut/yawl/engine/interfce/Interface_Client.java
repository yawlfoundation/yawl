...
public class Interface_Client {
    ...
    public static String executePost(String urlStr, Map paramsMap) throws IOException {
        ...
        while (paramKeys.hasNext()) {
            ...
            String paramValue = maskAmps((String) paramsMap.get(paramName)) ;
    ...
    public static String executeGet(String urlStr) throws IOException {
        ...
        if (index != -1) {
            String firstHalf = urlStr.substring(0, index + 1);
    ...
    /** masks all &'s in a data string with an unlikely set of characters */
    protected static String maskAmps(String s) {
        return s.replaceAll("&", "_;;@;;_");
    }

    /** replaces the masked & in the string with the original & */
    protected static String unmaskAmps(String s) {
        return s.replaceAll("_;;@;;_", "&");
    }

    /** replaces the masked & in the string with the original & */
    protected static Map unmaskAmps(Map paramMap) {
        String key, value ;
        Object o;
        ...
        while (itr.hasNext()) {
            ...
            if (o instanceof String) {
               ...
               paramMap.put(key, unmaskAmps(value));
            }
        }
        return paramMap;
    }
