 ...
 * @version $Id: XFormsSessionManager.java,v 1.3 2006/12/18 10:30:01 deliriumsky Exp $
 */
public interface XFormsSessionManager {
     ...
     * @param milliseconds the amount of time before wiping a session in milliseconds
     */
     ...
     *
     */
    void setInterval(int wipingInterval);
    void init();
}
