...
<form method="post" action="http://131.181.70.9:8080/admintool/addServlet" name="addSubRes">
...
<table bgcolor="lightgrey">
<form method="post" action="http://131.181.70.9:8080/admintool/addServlet" name="addSubPos">
