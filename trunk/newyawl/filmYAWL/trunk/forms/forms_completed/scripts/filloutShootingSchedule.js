...
function addCharacterRow(day, table) {//works
	...
	cell.appendChild(createTextBox("sd"+day+"_charactername"+table+"_"+temp_character_count, 20, "","Enter Character Name."));
}
...
function addMealBreak(day, table) {//works
	...
	mealtimesCELL.appendChild(createTextBox("sd"+day+"_break"+table, 25, "", "Enter Meal Break."));
...
function addShootingDay () {
	...
	shootingdayTABLE.setAttribute("id", "day" + count);
	...
	topmiddleCELL.appendChild(createTextBox("sd"+temp_day_count+"_number", 5, "", "Enter Shoot Day"));
	...
	shootdateCELL.appendChild(createTextBox("sd"+temp_day_count+"_date", 20, "", "Enter Date."));
	...
	weekdayCELL.appendChild(createTextBox("sd"+temp_day_count+"_weekday", 20, "", "Enter Date."));
	...
	crewcallCELL.appendChild(createTextBox("sd"+temp_day_count+"_crew", 20, "", "Enter Crew Call"));
	...
	traveltolocCELL.appendChild(createTextBox("sd"+temp_day_count+"_traveltoloc", 20, "", "Enter Travel to Location"));
	...
	bumpinCELL.appendChild(createTextBox("sd"+temp_day_count+"_bumpin", 20, "", "Enter Bump In."));
	...
	startCELL.appendChild(createTextBox("sd"+temp_day_count+"_start",73, "", "Enter Start Day Notes"));
	startCELL.colSpan = "3";
	...
	totalscriptpagesCELL.appendChild(createTextBox("sd"+temp_day_count+"_totalpages", 4, "", "Enter Script Pages."));
	totalscriptpagesCELL.appendChild(document.createTextNode("\u00a0"));
	totalscriptpagesCELL.appendChild(createTextBox("sd"+temp_day_count+"_totalpagesnum", 2, "", "Enter Script Pages."));
	...
	tbody2.appendChild(shootingdayTABLE);
}
...
function createSceneTable () {//done
	...
	scenenoCELL.appendChild(createTextBox("sd"+temp_day_count+"_scene" + temp_table_count, 25, "", "Enter Scene Number."));
	//row 2
	...
	setnameCELL.appendChild(createTextBox("sd"+temp_day_count+"_set" + temp_table_count,20, "", "Enter Set Name."));
	synopsisLABEL.appendChild(createBoldLabel("Synopsis"));
	synopsisCELL.appendChild(createTextBox("sd"+temp_day_count+"_synopsis" + temp_table_count,20, "", "Enter Synopsis."));
	//row 3
	...
	locationidCELL.appendChild(createTextBox("sd"+temp_day_count+"_locationID" + temp_table_count, 20, "", "Enter Location ID."));
	addressLABEL.appendChild(createBoldLabel("Address"));
	addressCELL.appendChild(createTextBox("sd"+temp_day_count+"_address" + temp_table_count, 20, "", "Enter Address."));
	//row 4
	...
	scriptpagesCELL.appendChild(createTextBox("sd"+temp_day_count+"_pages" + temp_table_count, 4, "", "Enter Number of Script Pages."));
	scriptpagesCELL.appendChild(document.createTextNode("\u00a0"));
	scriptpagesCELL.appendChild(createTextBox("sd"+temp_day_count+"_pagesnum" + temp_table_count, 2, "", "Enter Number of Script Pages"));
	scriptpagesCELL.appendChild(createBoldLabel(" /8 pgs"));
	shoottimesLABEL.appendChild(createBoldLabel("Est. Shoot Times"));
	shoottimesCELL.appendChild(createTextBox("sd"+temp_day_count+"_times" + temp_table_count, 20, "", "Enter Est. Shoot Times."));
	//row 6
	...
	scripttimingCELL.appendChild(createTextBox("sd"+temp_day_count+"_scripttime" + temp_table_count, 20, "", "Enter Est. Script Timing."));
	//row 7
