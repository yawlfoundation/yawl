...
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
				...
				<tbody>
				   ...
				   <%
					...
					<tr align="center" valign="top">
						...
						<td><input name="counter_reading_1" type="text" id="counter_reading_1" size="6" pattern="number" title="Enter Counter Reading."></td>
						<td><input name="take_length_1" type="text" id="take_length_1" size="6" pattern="number" title="Enter Take Length."></td>
	...
	<%StockInfoType sti = focs.getStockInfo();%>
   	...
   	<tr><td>
		<input type="text" name="count" id="count" value="<%if (a==0) {out.print("1");}else{out.print(a);}%>"/>
