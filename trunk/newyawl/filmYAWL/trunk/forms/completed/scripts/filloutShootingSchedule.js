...
function addShootingDay () {
	...
	shootdateCELL.appendChild(createTextBox("sd"+temp_day_count+"_date", 20, "", "Enter Shoot Date."));
	...
	weekdayCELL.appendChild(createTextBox("sd"+temp_day_count+"_weekday", 20, "", "Enter Weekday."));
