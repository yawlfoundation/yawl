...
<!-- javascript imports -->
<script type="text/javascript" src="../forms_completed/scripts/common.js"></script>
<script type="text/javascript" src="../forms_completed/scripts/filloutLocationNotes.js"></script>
</head>
...
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<form name="form1" method="post">
		  <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			%>
                  ...
                  <tr>
                    ...
                    <td align="left"><input name="<% out.print("location_ID_" + a); %>" type="text" id="<% out.print("location_ID_" + a); %>" value="<%=slit.getLocationID() %>"></td>
                    <td align="left"><strong>Location Name </strong></td>
                    <td align="left"><input name="<% out.print("location_name_" + a); %>" type="text" id="<% out.print("location_name_" + a); %>" value="<%=slit.getLocationName() %>"></td>
                    <td class="right">&nbsp;</td>
                  </tr>
                  <tr>
                    <td class="left">&nbsp;</td>
                    <td align="left"><strong>Address</strong></td>
                    <td align="left"><input name="<% out.print("address_" + a); %>" type="text" id="<% out.print("address_" + a); %>" value="<%=slit.getAddress() %>"></td>
                    <td align="left"><strong>UBD Map Ref</strong></td>
                    <td align="left"><input name="<% out.print("ubd_" + a); %>" type="text" id="<% out.print("ubd_" + a); %>" value="<%=slit.getUBDMapRef() %>"></td>
                    <td class="right">&nbsp;</td>
                  </tr>
                  <tr>
                    <td class="left">&nbsp;</td>
                    <td align="left"><strong>Police</strong></td>
                    <td align="left"><input name="<% out.print("police_" + a); %>" type="text" id="<% out.print("police_" + a); %>" value="<%=slit.getPolice() %>"></td>
                    <td align="left"><strong>Hospital</strong></td>
                    <td align="left"><input name="<% out.print("hospital_" + a); %>" type="text" id="<% out.print("hospital_" + a); %>" value="<%=slit.getHospital() %>"></td>
                    <td class="right">&nbsp;</td>
                  </tr>
                  <tr>
                    <td class="left">&nbsp;</td>
                    <td align="left"><strong>Contact</strong></td>
                    <td align="left"><input name="<% out.print("contact_" + a); %>" type="text" id="<% out.print("contact_" + a); %>" value="<%=slit.getContact() %>"></td>
                    <td align="left"><strong>Contact No. </strong></td>
                    <td align="left"><input name="<% out.print("phone_" + a); %>" type="text" id="<% out.print("phone_" + a); %>" value="<%=slit.getContactNo() %>"></td>
                    <td class="right">&nbsp;</td>
                  </tr>
                  <tr>
                    <td class="left">&nbsp;</td>
                    <td align="left"><strong>Parking</strong></td>
                    <td colspan="3" align="left"><input name="<% out.print("parking_" + a); %>" type="text" id="<% out.print("parking_" + a); %>" size="80" value="<%=slit.getParking() %>"></td>
                    <td class="right">&nbsp;</td>
                  </tr>
                  <tr>
                    <td class="left">&nbsp;</td>
                    <td align="left"><strong>Unit</strong></td>
                    <td colspan="3" align="left"><input name="<% out.print("unit_" + a); %>" type="text" id="<% out.print("unit_" + a); %>" size="80" value="<%=slit.getUnit() %>"></td>
                    <td class="right">&nbsp;</td>
                  </tr>
                  <tr>
                    <td class="left">&nbsp;</td>
                  ...
                  <tr>
                    <td class="left">&nbsp;</td>
                    <td align="left"><strong>Location ID </strong></td>
                    <td align="left"><input name="location_ID_1" type="text" id="location_ID_1"></td>
                    <td align="left"><strong>Location Name </strong></td>
                    <td align="left"><input name="location_name_1" type="text" id="location_name_1"></td>
                    <td class="right">&nbsp;</td>
                  </tr>
                  <tr>
                    <td class="left">&nbsp;</td>
                    <td align="left"><strong>Address</strong></td>
                    <td align="left"><input name="address_1" type="text" id="address_1"></td>
                    <td align="left"><strong>UBD Map Ref</strong></td>
                    <td align="left"><input name="ubd_1" type="text" id="ubd_1"></td>
                    <td class="right">&nbsp;</td>
                  </tr>
                  <tr>
                    <td class="left">&nbsp;</td>
                    <td align="left"><strong>Police</strong></td>
                    <td align="left"><input name="police_1" type="text" id="police_1"></td>
                    <td align="left"><strong>Hospital</strong></td>
                    <td align="left"><input name="hospital_1" type="text" id="hospital_1"></td>
                    <td class="right">&nbsp;</td>
                  </tr>
                  <tr>
                    <td class="left">&nbsp;</td>
                    <td align="left"><strong>Contact</strong></td>
                    <td align="left"><input name="contact_1" type="text" id="contact_1"></td>
                    <td align="left"><strong>Contact No. </strong></td>
                    <td align="left"><input name="phone_1" type="text" id="phone_1"></td>
                    <td class="right">&nbsp;</td>
                  </tr>
                  <tr>
                    <td class="left">&nbsp;</td>
                    <td align="left"><strong>Parking</strong></td>
                    <td colspan="3" align="left"><input name="parking_1" type="text" id="parking_1" size="80"></td>
                    <td class="right">&nbsp;</td>
                  </tr>
                  <tr>
                    <td class="left">&nbsp;</td>
                    <td align="left"><strong>Unit</strong></td>
                    <td colspan="3" align="left"><input name="unit_1" type="text" id="unit_1" size="80"></td>
                    <td class="right">&nbsp;</td>
                  </tr>
                  <tr>
                    <td class="left">&nbsp;</td>
		  ...
		  <p align="center"><input name="button" type="button" onClick="createEntry();" value="Add Location"/>
		  <input name="button" type="button" onClick="deleteEntry();" value="Delete Location"/>
