...
- YAWLEditorLite1.5.jar (download from http://sourceforge.net/project/yawl - YAWL Editor/1.5/YAWLEditorLite1.5.jar or build from scarch)
...
You can then use Launch4j to give the icon "yawl.ico" to the installer. You can find this icon in build\Installer\icons.
