...
public class ExportToEngineFormatAction extends YAWLOpenSpecificationAction {

  {
    putValue(Action.SHORT_DESCRIPTION, " Export this specification to the YAWL engine file format ");
  ...
  public void actionPerformed(ActionEvent event) {
    ArchivingThread.getInstance().export();
  }
}
