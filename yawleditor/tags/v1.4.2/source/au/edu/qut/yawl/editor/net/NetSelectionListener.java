...
public class NetSelectionListener implements GraphSelectionListener {
  ...
  private void enableZoomActionIfAppropriate() {
    enableZoomAction(true);
  }
  
  private void enableZoomAction(boolean enabled) {
    ZoomSelectedElementsAction.getInstance().setEnabled(enabled);
  }
