...
public class NetGraph extends JGraph {
  ...
  public void moveElementBy(GraphCell cell, double x, double y) {
    if (cell instanceof VertexContainer) {
      translateDecoratedVertexView((VertexView) getViewFor(cell), x, y);
      translateLabelIfNecessary((VertexContainer) cell, x, y);
    } else {
      NetCellUtilities.translateView(this, getViewFor(cell), x, y);
    }
  }
  ...
  private void translateDecoratedVertexView(VertexView view, double x, double y) {
    VertexContainer vertexContainer = (VertexContainer) view.getCell();
  ...
  private void translateDecoratedTaskView(VertexView view, double x, double y) {
    VertexContainer decoratedTask = (VertexContainer) view.getCell();
