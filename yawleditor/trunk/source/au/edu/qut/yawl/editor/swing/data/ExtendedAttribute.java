...
public class ExtendedAttribute
{
     ...
     */
    public ExtendedAttribute(DataVariable variable, String name, String type, String value)
    {
     ...
     */
    public ExtendedAttribute(Decomposition decomposition, String name, String type, String value)
    {
    ...
    public JComponent getComponent()
    {
        if (component == null)
        {
            if (type.trim().equalsIgnoreCase("boolean"))
            {
            ...
            else if (type.trim().startsWith("enumereration"))
            {
                if (type.indexOf("{") == -1 || type.indexOf("}") == -1)
                {
                    //todo ill-formed enumereration. exception?
            ...
            else if (type.trim().startsWith("attribute"))
            {
                if (type.indexOf("${") == -1 || type.indexOf("}") == -1)
                {
